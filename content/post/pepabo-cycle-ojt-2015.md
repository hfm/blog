...
今年の新卒エンジニアは6人いるので、3人1組のチームとし、大きく2段階の課題を用意しました。
...
という、Web開発研修とWebオペレーションで作ってきたものが土台となっています。
ゴールは、Webで出来ることをモバイルアプリでも出来るようにすることで、API設計やUIデザインも含めた、チーム開発プロセスにも重きをおいています。
...
##### 2nd stage: 1で開発したモバイルアプリを土台にして、1つ以上の「ユーザ体験」をつくる

1st stage で開発したモバイルアプリのうえに、「新しい『ユーザ体験』」をつくってもらうことが 2nd stage のゴールです。
[リーンキャンバス](//github.com/demi168/Lean-Canvas-prototype-PDF)、[インセプションデッキ](//github.com/agile-samurai-ja/support/blob/master/blank-inception-deck/blank-inception-deck1-ja.pdf)といったプラクティスを活用しながら、他の人にも「つくったものによって、こういう体験が提供できます」と説明しうるソフトウェアを開発してもらうことが目的です。
